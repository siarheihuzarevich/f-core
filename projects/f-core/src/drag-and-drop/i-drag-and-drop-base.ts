import { IMouseEvent, IPointerEvent, ITouchDownEvent, ITouchMoveEvent, ITouchUpEvent } from './pointer-events';
import { EventExtensions, IPoint, PointExtensions } from '../types';
